use kendr_optimizer_contracts::{
    ...
    MessageRole, MoneyEstimate, OptimizationPolicy, OptimizePhase, OptimizeRequest, OutcomeStatus,
    ProviderUsage, RiskLevel, TargetContext, ToolDefinition, UsageObservation,
};
